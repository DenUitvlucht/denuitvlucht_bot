...
def get_financial_keyboard(): 
    return types.InlineKeyboardMarkup().row(types.InlineKeyboardButton('Payconiq', callback_data=financial_cd.new(action='payconiq_keyboard'))).row(types.InlineKeyboardButton('⬅️ Terug', callback_data=financial_cd.new(action='denuitvlucht')))
